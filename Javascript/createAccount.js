...
function sendCreateRequest(){
    ...
    var passwordValidFormat= /^(?=.*\d)(?=.*[a-zA-Z])/;
    if(username==''|| password==''){
        ...
        alert("Username can only consists of characters and numbers")
    }else if(password.length<6 || password.length >15 || !passwordValidFormat.test(password)) {
